export default {
  ...
  'settings.users.disableAccount': '禁用账号',
  'settings.users.save': '保存',
  'settings.users.saving': '保存中…',
  'settings.users.copy': '复制',
  'settings.users.copied': '已复制',
  ...
  'settings.users.token.regenerate': '重新生成令牌',
  'settings.users.token.regenerating': '生成中…',
