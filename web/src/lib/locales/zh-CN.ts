export default {
  ...
  'newSession.project.outsideOption': '不在工作目录内',
  ...
  'settings.projects.description': '创建共享项目、绑定 runner 工作目录，并邀请用户加入。',
  ...
  'settings.projects.create.rootPath': '工作目录根路径',
  ...
  'settings.projects.workspaces': '工作目录',
  'settings.projects.workspaces.empty': '暂无工作目录。',
  'settings.projects.members': '成员',
  'settings.projects.members.empty': '暂无成员。',
  'settings.projects.userId': '用户 {id}',
  'settings.projects.workspace.add': '添加工作目录',
  'settings.projects.workspace.rootPlaceholder': '/path/to/workspace',
  'settings.projects.workspace.required': '请选择设备并填写工作目录。',
  'settings.projects.workspace.submit': '添加工作目录',
  'settings.projects.workspace.adding': '添加中…',
  'settings.projects.workspace.error': '添加工作目录失败。',
  'settings.projects.workspace.remove': '移除',
  'settings.projects.workspace.removing': '移除中…',
  'settings.projects.workspace.removeAria': '移除工作目录 {path}',
  'settings.projects.workspace.removeError': '移除工作目录失败。',
  'settings.projects.member.add': '添加成员',
  'settings.projects.member.userIdPlaceholder': '用户 ID',
  'settings.projects.member.required': '请输入有效用户 ID。',
