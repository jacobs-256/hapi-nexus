export default {
  ...
  'newSession.project.outsideOption': 'outside workspace',
  ...
  'settings.projects.description': 'Create shared projects, attach runner workspaces, and invite users.',
  ...
  'settings.projects.create.rootPath': 'Workspace root',
  ...
  'settings.projects.workspaces': 'Workspaces',
  'settings.projects.workspaces.empty': 'No workspaces.',
  'settings.projects.members': 'Members',
  'settings.projects.members.empty': 'No members.',
  'settings.projects.userId': 'User {id}',
  'settings.projects.workspace.add': 'Add workspace',
  'settings.projects.workspace.rootPlaceholder': '/path/to/workspace',
  'settings.projects.workspace.required': 'Machine and workspace root are required.',
  'settings.projects.workspace.submit': 'Add workspace',
  'settings.projects.workspace.adding': 'Adding…',
  'settings.projects.workspace.error': 'Could not add workspace.',
  'settings.projects.workspace.remove': 'Remove',
  'settings.projects.workspace.removing': 'Removing…',
  'settings.projects.workspace.removeAria': 'Remove workspace {path}',
  'settings.projects.workspace.removeError': 'Could not remove workspace.',
  'settings.projects.member.add': 'Add member',
  'settings.projects.member.userIdPlaceholder': 'User ID',
  'settings.projects.member.required': 'Enter a valid user ID.',
