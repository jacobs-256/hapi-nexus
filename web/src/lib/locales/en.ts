export default {
  ...
  // Login / Auth
  'login.title': 'HAPI Private Hub',
  'login.subtitle': 'Sign in to your organization workspace',
  'login.workspace': 'Organization workspace',
  'login.bind.title': 'Bind Telegram',
  'login.submit': 'Sign In',
  'login.bind.submit': 'Bind',
  'login.submitting': 'Signing in…',
  'login.bind.submitting': 'Binding…',
  'login.theme.light': 'Light mode',
  'login.theme.dark': 'Dark mode',
  'login.placeholder': 'Access token',
  'login.username': 'Username',
  'login.password': 'Password',
  'login.rememberMe': 'Remember me',
  'login.showSecret': 'Show secret',
  'login.hideSecret': 'Hide secret',
  'login.error.enterToken': 'Please enter an access token',
  'login.error.enterCredentials': 'Please enter a username and password',
  'login.error.noAccessToken': 'This account does not have an access token.',
  ...
  'login.server.default': '(Same origin)',
  ...
  'sessions.group.renameInput': 'Group display name',
  'sessions.group.renamePlaceholder': 'Display name',
  'sessions.group.shared': 'Shared',
  'sessions.group.active': '{n} active',
  'sessions.group.pending': '{n} pending request(s)',
  'sessions.group.details.open': 'View group details',
  'sessions.group.details.createdAt': 'Created',
  'sessions.group.details.updatedAt': 'Last active',
  'sessions.group.details.machine': 'Machine',
  'sessions.group.details.project': 'Project',
  'sessions.group.details.path': 'Path',
  'sessions.group.details.sessions': 'Sessions',
  'sessions.group.details.sharedBy': 'Shared by',
  'sessions.group.details.none': 'None',
  'sessions.group.details.unknown': 'Unknown',
  'sessions.group.details.moveTitle': 'Move directory to project',
  'sessions.group.details.movePlaceholder': 'Select project',
  'sessions.group.details.move': 'Move',
  'sessions.group.details.moving': 'Moving...',
  'sessions.group.details.moveNoProject': 'This folder is not linked to a project.',
  'sessions.group.details.moveNoMachine': 'This folder is not linked to a machine.',
  'sessions.group.details.moveNoWorkspace': 'This folder is not linked to a machine.',
  'sessions.group.details.moveNoPermission': 'You need project admin access to move this folder.',
  'sessions.group.details.moveNoTargets': 'No other project is available.',
  'sessions.machineFilter.label': 'Filter sessions by machine',
  'sessions.machineFilter.all': 'All Machines',
  'sessions.machineFilter.machines': 'Machines',
  'sessions.machineFilter.selected': '{n} machines',
  'sessions.projectFilter.label': 'Project',
  'sessions.projectFilter.all': 'All Projects',
  ...
  'codexSync.confirm.description': 'Choose Codex sessions to queue for background import into Hapi',
  ...
  'codexSync.confirm.confirm': 'Queue import',
  'codexSync.confirm.confirming': 'Queueing…',
  'codexSync.confirm.loading': 'Loading local Codex sessions…',
  'codexSync.importQueue.title': 'Import queue',
  'codexSync.importQueue.queued.title': 'Import queued',
  'codexSync.importQueue.queued.body': 'Queued {n} Codex session(s) for background import.',
  'codexSync.importQueue.failed.body': 'Failed to create the import job.',
  'codexSync.importQueue.itemsProgress': '{done}/{total} sessions',
  'codexSync.importQueue.messagesProgress': '{done}/{total} messages',
  'codexSync.importQueue.moreItems': '{n} more session(s)…',
  'codexSync.importQueue.status.queued': 'Queued',
  'codexSync.importQueue.status.running': 'Importing',
  'codexSync.importQueue.status.succeeded': 'Completed',
  'codexSync.importQueue.status.failed': 'Failed',
  'codexSync.importQueue.item.queued': 'Waiting',
  'codexSync.importQueue.item.running': 'Importing',
  'codexSync.importQueue.item.succeeded': 'Done',
  'codexSync.importQueue.item.failed': 'Failed',
  'codexSync.importQueue.item.skipped': 'Skipped',
  'codexSync.success.title': 'Import complete',
  'codexSync.success.body': 'Imported {n} Codex session(s) into Hapi.',
  'codexSync.folder.sync': 'Sync folder',
  'codexSync.folder.syncing': 'Syncing…',
  'codexSync.folder.success.title': 'Folder history synced',
  'codexSync.folder.success.body': 'Synced {n} Codex session(s) from this folder.',
  'codexSync.folder.success.empty': 'No Codex sessions were found in this folder.',
  'codexSync.folder.failed.title': 'Failed to sync folder history',
  'codexSync.folder.error.machineRequired': 'Choose a machine before syncing Codex history.',
  'codexSync.folder.error.directoryRequired': 'Enter a directory before syncing Codex history.',
  ...
  'newSession.project.noneEditable': 'No editable projects',
  'newSession.project.outsideOption': 'outside project directory',
  'newSession.project.outsideWorkspace': 'This project does not include the selected directory.',
  ...
  'terminal.disabledBySettings': 'Terminal is disabled',
  'terminal.disabledBySettingsDescription': 'This web terminal entry is hidden by Settings → Chat → Tool order.',
  'terminal.disabledBack': 'Back to chat',
  ...
  'settings.hub.account.summary': 'Profile and access token',
  'settings.hub.users.summary': 'Accounts and roles',
  'settings.hub.projects.summary': 'Projects and sharing',
  'settings.general.title': 'General',
  'settings.storage.title': 'Storage',
  'settings.storage.summary': 'Hub storage backends',
  'settings.tasks.title': 'Tasks',
  'settings.tasks.summary': 'Sync task history',
  'settings.tasks.description': 'Review historical sync tasks, logs, errors, and cancel active tasks.',
  'settings.storage.description': 'Choose separate storage for conversation history and other Hub data, and optionally copy SQLite data when paths change.',
  ...
  'settings.storage.active.title': 'Active storage',
  'settings.storage.active.description': 'Current process configuration. Changes are saved to settings.json and take effect after hub restart.',
  'settings.storage.conversation.backend': 'Conversation backend',
  'settings.storage.core.backend': 'Core backend',
  'settings.storage.restartRequired': 'Restart required',
  'settings.storage.restartRequired.description': 'Saved storage settings differ from this running hub.',
  'settings.storage.sqliteUsage.title': 'SQLite usage',
  'settings.storage.sqliteUsage.coreTotal': 'Core total',
  'settings.storage.sqliteUsage.conversationTotal': 'Conversation total',
  'settings.storage.externalSync.title': 'External storage sync',
  'settings.storage.externalSync.description': 'Shows the latest asynchronous mirror/export status for MySQL or Elasticsearch backends.',
  'settings.storage.externalSync.core': 'Core data',
  'settings.storage.externalSync.conversation': 'Conversation records',
  'settings.storage.externalSync.running': 'Syncing',
  'settings.storage.externalSync.idle': 'Idle',
  'settings.storage.externalSync.failed': 'Failed',
  'settings.storage.externalSync.lastSuccess': 'Last success',
  'settings.storage.externalSync.lastRows': 'Last copied rows',
  'settings.storage.externalSync.lastError': 'Last error',
  'settings.storage.conversation.title': 'Conversation records',
  'settings.storage.conversation.description': "Stores session message history. Elasticsearch settings are saved for external storage and take effect after restart.",
  'settings.storage.core.title': 'Other hub data',
  'settings.storage.core.description': 'Stores users, permissions, projects, machines, notifications, and session metadata.',
  'settings.storage.field.sqlitePath': 'SQLite path',
  'settings.storage.field.esUrl': 'ES URL',
  'settings.storage.field.esIndex': 'ES index',
  'settings.storage.field.username': 'Username',
  'settings.storage.field.passwordApiKey': 'Password / API key',
  'settings.storage.field.apiKey': 'API Key (base64)',
  'settings.storage.field.mysqlUrl': 'MySQL URL',
  'settings.storage.field.host': 'Host',
  'settings.storage.field.port': 'Port',
  ...
  'settings.storage.migration.none.description': 'Only save config',
  'settings.storage.migration.copy': 'Copy data',
  'settings.storage.migration.copy.description': 'Copy/export current data into the configured target when possible.',
  'settings.storage.migration.started': 'Data migration has started in the background. Please avoid logging in or operating until it finishes.',
  'settings.storage.migration.statusTitle': 'Migration status',
  'settings.storage.migration.status': 'Status',
  'settings.storage.migration.status.running': 'Running',
  'settings.storage.migration.status.success': 'Success',
  'settings.storage.migration.status.failed': 'Failed',
  'settings.storage.migration.status.idle': 'Idle',
  'settings.storage.migration.startedAt': 'Started at',
  'settings.storage.migration.finishedAt': 'Finished at',
  'storageMigration.overlay.title': 'Migrating data',
  'storageMigration.overlay.body': 'The server is migrating storage data. Please wait before logging in or operating the web app. You may close this page; it will check again when reopened.',
  'storageMigration.overlay.startedAt': 'Started at: {time}',
  'settings.storage.migration.exportedRows': 'Exported {count} row(s) to configured external storage.',
  'settings.storage.migration.copiedSqlite': 'Copied SQLite tables into configured storage files.',
  'settings.storage.migration.pathsUnchanged': 'Storage paths unchanged; no migration needed.',
  'settings.storage.migration.sourceSqliteOnly': 'Source migration currently supports SQLite only.',
  'settings.storage.migration.targetSqliteOnly': 'Target migration currently supports SQLite only. Save config, then run external MySQL/Elasticsearch migration tooling.',
  'settings.storage.savedRestart': 'Storage settings saved. Restart the hub to activate changes.',
  'settings.storage.restarting': 'Storage settings saved. Hub is restarting…',
  'settings.storage.saved': 'Storage settings saved.',
  ...
  'settings.storage.saveRestart': 'Save and restart Hub',
  'settings.storage.restartConfirm': 'Saving storage settings will restart the Hub. Confirm that systemd, pm2, Docker, bun --watch, or another supervisor will start it again; otherwise the service will stop. Continue?',
  'settings.storage.apiUnavailable': 'API unavailable',
  ...
  'settings.chat.composerToolbar.description': 'Choose how toolbar actions are arranged below the message input, or disable tools you do not want available on the web.',
  ...
  'settings.chat.composerToolbar.enableTool': 'Enable tool',
  'settings.chat.composerToolbar.disableTool': 'Disable tool',
  'settings.chat.composerToolbar.enabled': 'Enabled',
  'settings.chat.composerToolbar.disabled': 'Disabled',
  'settings.chat.composerToolbar.globalBadge': 'Global',
  'settings.chat.composerToolbar.disableGlobally': 'Disable globally',
  'settings.chat.composerToolbar.enableGlobally': 'Enable globally',
  'settings.chat.composerToolbar.globalError': 'Failed to update global toolbar settings.',
  'settings.chat.composerToolbar.disableHint': 'Disabled tools stay in this order list, but are hidden and cannot be opened from the web composer.',
  ...
  'settings.account.description': 'Your profile, namespace, role, and personal access token.',
  'settings.account.profile': 'Profile',
  'settings.account.name': 'Name',
  'settings.account.username': 'Username',
  'settings.account.role': 'Role',
  'settings.account.namespace': 'Namespace',
  'settings.account.token': 'Access token',
  'settings.account.copy': 'Copy',
  'settings.account.copied': 'Copied',
  'settings.account.regenerate': 'Regenerate token',
  'settings.account.regenerating': 'Regenerating…',
  'settings.account.regenerateError': 'Could not regenerate token.',
  'settings.account.ownerTokenHint': 'Hub owner token is managed by CLI_API_TOKEN.',
  'settings.account.error': 'Unable to load account.',
  'settings.account.username.section': 'Username',
  'settings.account.username.placeholder': 'Username',
  'settings.account.username.save': 'Change username',
  'settings.account.username.saving': 'Saving…',
  'settings.account.username.saved': 'Username changed.',
  'settings.account.username.required': 'Username is required.',
  'settings.account.username.error': 'Could not change username. The username may already exist.',
  'settings.account.username.ownerHint': 'Hub owner username is fixed. Sign in with a local account to change a username.',
  'settings.account.password.section': 'Password',
  ...
  'settings.account.password.save': 'Change password',
  'settings.account.password.saving': 'Saving…',
  'settings.account.password.saved': 'Password changed.',
  'settings.account.password.required': 'New password must be at least 8 characters.',
  'settings.account.password.mismatch': 'New passwords do not match.',
  'settings.account.password.error': 'Could not change password.',
  'settings.account.password.ownerHint': 'Hub owner does not have a local password. Sign in with a local account to change a password.',
  'settings.account.session': 'Session',
  'settings.account.logout': 'Sign out',
  'settings.account.logoutDescription': 'Clear this browser session and return to the sign-in page.',
  'settings.users.title': 'Users',
  'settings.users.description': 'Create local users, assign admin access, reset passwords, and issue personal access tokens.',
  'settings.users.create.section': 'Create user',
  'settings.users.list.section': 'Users',
  'settings.users.columns.user': 'User',
  'settings.users.columns.displayName': 'Display name',
  'settings.users.columns.role': 'Role',
  'settings.users.columns.status': 'Status',
  'settings.users.columns.security': 'Password',
  'settings.users.columns.actions': 'Actions',
  'settings.users.username': 'Username',
  'settings.users.displayName': 'Display name',
  'settings.users.password': 'Password (8+ characters)',
  ...
  'settings.users.saving': 'Saving…',
  'settings.users.create.required': 'Username and an 8+ character password are required.',
  'settings.users.create.submit': 'Create user',
  'settings.users.create.creating': 'Creating…',
  'settings.users.create.error': 'Could not create user.',
  'settings.users.password.reset': 'Reset password',
  'settings.users.password.saving': 'Saving…',
  'settings.users.delete.action': 'Delete user',
  'settings.users.delete.title': 'Delete user',
  'settings.users.delete.description': 'Delete {name}? This cannot be undone.',
  'settings.users.delete.confirm': 'Delete',
  'settings.users.delete.deleting': 'Deleting…',
  'settings.users.update.error': 'Could not update user.',
  'settings.users.load.error': 'Unable to load users.',
  'settings.users.empty': 'No users yet.',
  'settings.users.adminOnly': 'Only administrators can manage users.',
  'settings.projects.title': 'Projects',
  'settings.projects.description': 'Create shared projects, attach project directories, and invite users.',
  'settings.projects.create.section': 'Create project',
  'settings.projects.create.name': 'Name',
  'settings.projects.create.namePlaceholder': 'Project name',
  'settings.projects.create.nameRequired': 'Project name is required.',
  'settings.projects.create.machine': 'Machine',
  'settings.projects.create.rootPath': 'Project directory',
  'settings.projects.create.rootPathPlaceholder': '/path/to/project',
  'settings.projects.create.submit': 'Create project',
  'settings.projects.create.creating': 'Creating…',
  'settings.projects.create.error': 'Could not create project.',
  'settings.projects.list.section': 'Projects',
  'settings.projects.empty': 'No projects yet.',
  'settings.projects.columns.project': 'Project',
  'settings.projects.columns.role': 'Role',
  'settings.projects.columns.workspaces': 'Directories',
  'settings.projects.columns.members': 'Members',
  'settings.projects.columns.actions': 'Actions',
  'settings.projects.details.view': 'Details',
  'settings.projects.details.hide': 'Hide details',
  'settings.projects.details.viewAria': 'View details for {name}',
  'settings.projects.summary.workspaces': '{count} directories',
  'settings.projects.summary.members': '{count} members',
  'settings.projects.manage': 'Manage project',
  'settings.projects.noMachines': 'No machines online',
  'settings.projects.rename': 'Rename {name}',
  'settings.projects.rename.action': 'Rename',
  'settings.projects.rename.save': 'Save',
  'settings.projects.rename.saving': 'Saving…',
  'settings.projects.rename.cancel': 'Cancel',
  'settings.projects.rename.error': 'Could not rename project.',
  'settings.projects.role.owner': 'Owner',
  'settings.projects.role.admin': 'Admin',
  'settings.projects.role.editor': 'Editor',
  'settings.projects.role.viewer': 'Viewer',
  'settings.projects.workspaces': 'Project directories',
  'settings.projects.workspaces.empty': 'No project directories.',
  'settings.projects.members': 'Members',
  'settings.projects.members.empty': 'No members.',
  'settings.projects.userId': 'User {id}',
  'settings.projects.workspace.add': 'Add project directory',
  'settings.projects.workspace.addShort': 'Add directory',
  'settings.projects.workspace.addAria': 'Add directory to {name}',
  'settings.projects.workspace.browse': 'Browse',
  'settings.projects.workspace.browseAria': 'Browse project directory',
  'settings.projects.workspace.noRoots': 'This machine has no runner workspace roots.',
  'settings.projects.workspace.rootPlaceholder': '/path/to/project',
  'settings.projects.workspace.required': 'Machine and project directory are required.',
  'settings.projects.workspace.select': 'Select directory',
  'settings.projects.workspace.submit': 'Add directory',
  'settings.projects.workspace.adding': 'Adding…',
  'settings.projects.workspace.error': 'Could not add project directory.',
  'settings.projects.workspace.remove': 'Remove',
  'settings.projects.workspace.removing': 'Removing…',
  'settings.projects.workspace.removeAria': 'Remove project directory {path}',
  'settings.projects.workspace.removeError': 'Could not remove project directory.',
  'settings.projects.member.add': 'Add member',
  'settings.projects.member.addShort': 'Add member',
  'settings.projects.member.addAria': 'Add member to {name}',
  'settings.projects.member.userIdPlaceholder': 'User ID',
  'settings.projects.member.searchPlaceholder': 'Search username or display name',
  'settings.projects.member.selectUsers': 'Select users',
  'settings.projects.member.selectedCount': '{count} selected',
  'settings.projects.member.removeSelected': 'Remove {name}',
  'settings.projects.member.noUsers': 'No users available.',
  'settings.projects.member.noResults': 'No matching users.',
  'settings.projects.member.usersLoading': 'Loading users…',
  'settings.projects.member.usersError': 'Could not load users.',
  'settings.projects.member.required': 'Select at least one user.',
  'settings.projects.member.submit': 'Add member',
  'settings.projects.member.adding': 'Adding…',
  'settings.projects.member.roleAria': 'Change role for user {id}',
  'settings.projects.member.remove': 'Remove',
  'settings.projects.member.removing': 'Removing…',
  'settings.projects.member.removeAria': 'Remove user {id}',
  'settings.projects.member.error': 'Could not update project member.',
  'settings.projects.invite.create': 'Invite user',
  'settings.projects.invite.createShort': 'Invite',
  'settings.projects.invite.createAria': 'Create invite for {name}',
  'settings.projects.invite.submit': 'Create link',
  'settings.projects.invite.creating': 'Creating…',
  'settings.projects.invite.error': 'Could not create invite.',
  'settings.projects.invite.copy': 'Copy',
  'settings.projects.invite.copied': 'Copied',
  'settings.machines.title': 'Machines',
  'settings.machines.description': 'Give your machines names of your own and manage registered runners.',
  ...
  'settings.machines.shared': 'Shared',
  'settings.machines.sharedBy': 'Shared by {name}',
  'settings.machines.status.online': 'Online',
  'settings.machines.status.offline': 'Offline',
  'settings.machines.lastSeen': 'Last seen: {time}',
  'settings.machines.lastOffline': 'Last offline: {time}',
  'settings.machines.lastOfflineUnknown': 'Last offline: unknown',
  'settings.machines.delete.action': 'Delete',
  'settings.machines.delete.aria': 'Delete {name}',
  'settings.machines.delete.onlineHint': 'Stop this runner before deleting it.',
  'settings.machines.delete.title': 'Delete machine',
  'settings.machines.delete.description': 'Delete {name}? This will remove this machine, its project directories, projects that only belong to this machine, and related sessions. This cannot be undone.',
  'settings.machines.delete.confirm': 'Delete',
  'settings.machines.delete.deleting': 'Deleting…',
  ...
  // Project invites
  'invite.accept.loading': 'Accepting invite…',
  'invite.accept.success.title': 'Project joined',
  'invite.accept.success.body': 'The project is now available in HAPI.',
  'invite.accept.openProjects': 'Open projects',
  'invite.accept.failed.title': 'Invite failed',
  'invite.accept.failed.body': 'Could not accept this invite.',
  ...
  'codexSync.newSessionInline.description': 'Optional: read local Codex history and queue selected sessions for background import.',
